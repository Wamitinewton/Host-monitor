...
import 'package:cipherly/host%20manager/screens/main_screen/components/blinking_circle.dart';
import 'package:cipherly/host%20manager/screens/main_screen/components/interactive_graph.dart';
import 'package:cipherly/host%20manager/screens/main_screen/components/recent_stats.dart';
import 'package:cipherly/host%20manager/utils/to_csv.dart';
import 'package:flutter/material.dart';
import 'package:sliver_tools/sliver_tools.dart';
import 'package:url_launcher/url_launcher.dart';

import '../../../data/models/host.dart';
import '../../../data/models/ping.dart';
...
class _HostTileState extends State<HostTile> {
  ...
  void toggleRunning() {
    statsRepository
        .updateHost(widget.host.copyWith(enabled: !widget.host.enabled));
  ...
  exportData() async {
    ...
    AppLogger.debug('export data ${widget.host.adress} ${data.length}',
        name: 'HostTile');
                          ...
                          child: Opacity(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                StreamBuilder(
                                  stream: statsRepository.eventBus.where(
                                      (event) =>
                                          event is PingAdded &&
                                          event.ping.host ==
                                              widget.host.adress),
          ...
          child: RepaintBoundary(
            child: AnimatedContainer(
              ...
              child: OverflowBox(
                ...
                child: expanded
                    ? InteractiveGraph(
                        host: widget.host.adress, rasterScale: rasterScale)
                    : null,
              ),
            ),
          ),
  ...
  Widget menuButton() {
    return Container(
      ...
      child: PopupMenuButton(
        ...
        itemBuilder: (context) => [
          widget.host.enabled
              ? const PopupMenuItem(value: 'toggle', child: Text('Disable'))
              : const PopupMenuItem(value: 'toggle', child: Text('Enable')),
