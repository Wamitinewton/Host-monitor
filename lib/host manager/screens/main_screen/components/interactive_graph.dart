...
import 'package:cipherly/host%20manager/screens/main_screen/components/interactive_graph_painter.dart';
...
class _InteractiveGraphState extends State<InteractiveGraph> {
  ...
  late Duration selectedPeriod = const Duration(minutes: 15);
