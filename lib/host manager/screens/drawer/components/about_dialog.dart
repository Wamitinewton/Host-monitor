        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return AboutDialog(
              ...
              applicationLegalese: '© 2023 - ${DateTime.now().year}\nAthena Developers',
              children: [
                ...
                Text.rich(
                  TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: 'Email',
                        recognizer: TapGestureRecognizer()..onTap = () => launchUrl(Uri.parse('mailto:wamitinewton@gmail.com@gmail.com?subject=xdslmt')),
                        style: TextStyle(decoration: TextDecoration.underline),
                      ),
                    ],
                  ),
